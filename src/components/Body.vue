  ...
  <div class="body">
    <div class="section">
          ...
          >
            ...
            <template slot="tooltip" scope="tooltip">
              <div style="fontSize: 14px">
                <span v-if="tooltip.value < 7" class="lightToolTip toolTipDriver">{{tooltip.value}}</span>
                <span v-if="tooltip.value >= 7 && tooltip.value < 12" class="mediumToolTip toolTipDriver">{{tooltip.value}}</span>
                <span v-if="tooltip.value >= 12" class="heavyToolTip toolTipDriver">{{tooltip.value}}</span>
               </div>
            </template>
          </vue-slider> -->
      ...
      <!-- <div>
        ...
        <a class="button is-small is-primary" @click="lightDrivers">Light</a>
        <a class="button is-small is-info" @click="mediumDrivers">Medium</a>
        <a class="button is-small is-danger" @click="heavyDrivers">Heavy</a>
      </div>

      <br>

      <template class="columns" v-for="driver in driverSizeList">
        <template v-for="name in driver.name" >
          <a v-if="driver.size=='Light'" class="button is-small is-primary" style="margin:3px">{{ name }}</a>
          <a v-if="driver.size=='Medium'" class="button is-small is-info" style="margin:3px">{{ name }}</a>
          <a v-if="driver.size=='Heavy'" class="button is-small is-danger" style="margin:3px">{{ name }}</a>
        </template>
      </template> -->
      ...
      <vue-slider
          ...
          >
            ...
            <template class="columns" v-for="body in bodiesList">
