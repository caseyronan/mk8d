<template>
  <div class="DriverChart">
    ...
    <div class="driver-chart">
      ...
      :height="100"
      ></BarChart>
      <!-- <LineChart v-if="this.chartType == 2"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="100"
      ></LineChart>
      <BarChart v-if="this.chartType == 3"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="100"
      ></BarChart>
      <LineChart v-if="this.chartType == 4"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="100"
      ></LineChart> -->
    ...
    <!-- Driver buttons -->
    <div class="driver-buttons columns">
      <!-- Column 1 -->
      <div class="column">
        <a class="button is-small is-outlined" @click="newChart">Type</a>
        <span> | </span>
      ...
      <div class="column">
        <!-- New buttons go here -->
        <!-- <a class="button is-small" @click="toggleLegend">Legend</a> -->
      </div>
    </div>
