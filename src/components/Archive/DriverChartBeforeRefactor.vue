<template>
  <div class="DriverChart">
    ...
    <div class="small">
      ...
      <BarChart v-if="this.typeBar == 1"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="300"
      ></BarChart>

      <LineChart v-if="this.typeBar == 2"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="300"
      ></LineChart>

      <BarChart v-if="this.typeBar == 3"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="300"
      ></BarChart>

      <LineChart v-if="this.typeBar == 4"
      :chart-data="DrawChart[0]"
      :options="DrawChart[1]"
      :height="300"
      ></LineChart>
...
<!--  <div class="small">
  ...
  ></driver-chart>
      ...
      <driver-slider
        ...
        <div class="driver-icons" style="margin-top:40px">
          <div class="dr-icons">
          ...
          <div class="dr-icons">
            ...
            <a class="placeholder">
              <img src="../assets/blank32x32.png" title="">
            </a>
      ...
      <div>
        ...
        <span>|</span>
        <a class="button is-small" @click="chartType">Type</a>
      </div>
    </div>
</template>
...
export default {
  ...
  methods : {
    initChart() {
      this.dataCollection = this.DrawChart[0];
      this.chartOptions = this.DrawChart[1];
    ...
    chartType(){
      ...
      // line
      else if (this.typeBar == 2) {
        this.stackChart();
        this.typeBar = 3;
      }

      // stacked
      else if (this.typeBar == 3) {
        this.lineFill = !this.lineFill;
        this.stackChart();
        this.bgAlpha = 0.3;
        this.typeBar = 4;
      }
...
/*
  ...
  /*    console.log(this.chartOptions)
      // this.initChart()
      this.chartOptions.scales.xAxes[0].stacked = this.stacked;
      this.chartOptions.scales.yAxes[0].stacked = this.stacked;
      this.chartOptions.scales.yAxes[0].ticks.max = this.tickMax;
      this.chartOptions.scales.yAxes[0].ticks.stepSize = this.tickStep;

      console.log(this.chartOptions)
*/
  //    var ctx = document.getElementById("bar-chart").getContext("2d");
      // var config = [this.dataCollection, this.chartOptions];
    //  var MyChart = new Chart(ctx, {type: 'bar', data: this.dataCollection, options: this.chartOptions});
//      MyChart.update();
    },
    selectSize(num){
    ...
    //      this.chartOptions = chartOpt;
      ...
      var chartData = {
        ...
        datasets: [
          {
            label: 'Speed',
            backgroundColor: this.rgbaColor('255,215,0'), // FFD700 255,215,0
            borderColor: 'Gold',
            data: dataSet1,
            hidden: false,
            fill: this.lineFill,
          ...
          {
            label: 'Acceleration',
            backgroundColor: this.rgbaColor('0,191,255'), // 00BFFF 0,191,255
          ...
          {
            label: 'Weight',
            backgroundColor: this.rgbaColor('255,20,147'), // FF1493 255,20,147
          ...
          {
            label: 'Handling',
            backgroundColor: this.rgbaColor('106,90,205'), // 6A5ACD 106,90,205
          ...
          {
            label: 'Traction',
            backgroundColor: this.rgbaColor('50,205,50'), // 32CD32 50,205,50
