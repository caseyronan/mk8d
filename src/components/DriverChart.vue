...
<div class="driver">
  ...
  <div class="driver-thumbs">
    <div class="driver-thumbs-row">
      <a class="thumbVisible" @click="filterOutDriver(1)" v-bind:class="{ thumbHidden: filterDriver(1) }">
          <img src="https://www.mariowiki.com/images/thumb/3/3d/MK8_BabyPeach_Icon.png/32px-MK8_BabyPeach_Icon.png" title= "Baby Peach">
        </a>
      <a class="thumbVisible" @click="filterOutDriver(2)" v-bind:class="{ thumbHidden: filterDriver(2) }">
      ...
      <a class="thumbVisible" @click="filterOutDriver(3) " v-bind:class="{ thumbHidden: filterDriver(3) }">
      ...
      <a class="thumbVisible" @click="filterOutDriver(4)" v-bind:class="{ thumbHidden: filterDriver(4) }">
      ...
      <a class="thumbVisible" @click="filterOutDriver(16)" v-bind:class="{ thumbHidden: filterDriver(16) }">
