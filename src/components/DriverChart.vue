...
<div class="driver">
  ...
  <bar-chart v-if="this.chartType==='bar'" :height="250" :chart-data="DrawChart[0]" :options="DrawChart[1]">
  </bar-chart>

  <line-chart v-if="this.chartType==='line'" :height="250" :chart-data="DrawChart[0]" :options="DrawChart[1]">
  </line-chart>

  <stacked-chart v-if="this.chartType==='stacked'" :height="250" :chart-data="DrawChart[0]" :options="DrawChart[1]">
  </stacked-chart>

  <div class="simple-toggles">
    <a class="button is-small" style="padding:2px; margin:2px; border: 2px solid Gold" v-bind:class="{ hidden:this.hideSpeed }" @click="ToggleData(1)">Speed</a>
    <a class="button is-small" style="padding:2px; margin:2px; border: 2px solid DeepSkyBlue" v-bind:class="{ hidden:this.hideAcceleration }" @click="ToggleData(2)">Accel.</a>
    <a class="button is-small" style="padding:2px; margin:2px; border: 2px solid DeepPink" v-bind:class="{ hidden:this.hideWeight }" @click="ToggleData(3)">Weight</a>
    <a class="button is-small" style="padding:2px; margin:2px; border: 2px solid SlateBlue" v-bind:class="{ hidden:this.hideHandling }" @click="ToggleData(4)">Handling</a>
    <a class="button is-small" style="padding:2px; margin:2px; border: 2px solid LimeGreen" v-bind:class="{ hidden:this.hideTraction }" @click="ToggleData(5)">Traction</a>
  </div>

  <driver-slider id="driver-slider" v-model="drSizeFilter" :height="14" :dot-size="26" :min="1" :max="16" :piecewise-label="true" :bg-style='{backgroundColor:"#D5D5D5"}' :process-style='{backgroundColor:"#FFDB4A"}'>
  ...
  <!-- Driver buttons -->
  <div>
    <a class="button is-small" @click="changeChartType()">
      <span><i class="fa fa-line-chart" aria-hidden="true"></i></span>
      <!-- <span v-if="this.chartType==='line'"><i class="fa fa-area-chart" aria-hidden="true"></i></span>
    <span v-if="this.chartType==='stacked'"><i class="fa fa-bar-chart" aria-hidden="true"></i></span> -->
    </a>
